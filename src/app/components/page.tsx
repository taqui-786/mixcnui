...
function ComponentsPage() {
    ...
    const components: ComponentCard[] = [
        ...
        },
        {
            ...
            description: "Animated notification component with multiple types and positions, powered by framer-motion.",
            href: "/docs/components/floatingnotification",
            tags: ["notification", "toast", "animation", "framer-motion"],
            preview: (
                <div className="flex flex-col gap-2">
                    <FloatingNotification message="Success!" type="success" position="top-center" autoClose={false} />
                </div>
            ),
        },
        {
            title: "Loading Spinner",
            description: "Collection of animated loading spinners with multiple variants and customizable styles.",
            href: "/docs/components/loadingspinner",
            tags: ["loading", "spinner", "animation", "framer-motion"],
            preview: (
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-screen-xl">
            {/* Header Section */}
            <div className="mb-10">
                <h1 className="text-4xl font-bold text-primary mb-3">Browse Components</h1>
                <p className="text-muted-foreground text-lg mb-6">Explore our collection of beautiful and reusable components</p>
                ...
                {filteredComponents.map((component, index) => (
                    <div
                            ...
                            <div className="absolute inset-0 flex justify-center items-center p-6 overflow-hidden">
                                <div className="transform-gpu transition-transform duration-300 group-hover:scale-105 w-full flex justify-center items-center">
                                    <div className="max-w-full max-h-full overflow-auto flex justify-center items-center">
                                        ...
                                        <div className="transform scale-90">{component.preview}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-5 flex flex-col flex-grow w-full">
                            ...
                            <p className="text-muted-foreground mb-4 flex-grow line-clamp-2">{component.description}</p>
                            ...
                            <Link href={component.href} className={cn(buttonVariants(), "w-full group-hover:bg-primary/90 transition-colors")}>
                                View Details
                            </Link>
                        </div>
                    </div>
                ...
                <div className="group flex flex-col bg-card/50 border-2 border-dashed rounded-xl overflow-hidden">
                    <div className="min-h-[200px] md:min-h-[250px] w-full flex items-center justify-center p-6">
                        <div className="text-center">
                            ...
                            <h3 className="text-xl font-semibold text-muted-foreground mb-2">More Components</h3>
                            <p className="text-sm text-muted-foreground">New components are being crafted</p>
                        </div>
                    </div>
                </div>
            </div>
